...
$getcurl_event = postcurl($base_api_dashboard . 'latihan', $data);
                ...
                <div class="card-body" style="min-height:50vh">
                    <div class="row g-2">
                        ...
                        <div class="col-md-12 text-primary fs-6 text-center">
                            <span class="fw-bold fs-5">Kamu belum mengikuti Latihan</span><br>
                            Silakan ikuti latihan dan uji terus kesiapan Kamu dalam menghadapi Try Out
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row g-3" id="list-<?php echo $key ?>">
                                    <div class="col-md-3 divpilihmenu">
                                        <div class="row g-3">
                                            ...
                                            ?>
                                                <div class="col-md-12">
                                                    <div class="card click card<?php echo $key ?>" id="card-<?php echo $v['id_jawaban'] ?>" onclick="tampilnilai('<?php echo $v['id_jawaban'] ?>','<?php echo $key ?>','<?php echo $no ?>')">
                                                        <div class="card-body py-3">
                                                            <div class="row">
                                                                <div class="col-md-12 title fw-bold"><?php echo $v['judul'] ?></div>
                                                                <div class="col-md-12 subtitle small"><?php echo $v['materi_nama'] ?></div>
                                                                <div class="col-md-12">
                                                                    <div class="d-flex justify-content-start small text-secondary">
                                                                        <div class="me-2"><?php echo $v['waktu_pengerjaan'] ?></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-md-9 divpembahasan">
                                        <div class="card">
                                            <div class="card-body p-3" style="min-height:50vh" id="pembahasan-<?php echo $key ?>">
                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-md-12 text-primary fs-6 text-center">
                                                        ...
                                                        Klik List untuk menampilkan data
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    function tampilnilai(id_jawabannya, div_id, no) {

        $(".card" + div_id).removeClass("bg-primary");
        $("#card-" + id_jawabannya).addClass("bg-primary");

        var kiriman = JSON.stringify({
            email: "<?php echo $sesi['email'] ?>",
            id_jawaban: id_jawabannya,
        });

        $.ajax({
            url: '<?php echo $base_api_dashboard; ?>cari_nilai_materi/',
            type: 'POST',
            crossDomain: true,
            data: {
                "data": kiriman
            ...
            success: function(res) {
                ...
                $("#pembahasan-" + div_id).html(`
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6 bg-nilai rounded shadow-sm d-flex">
                ...
                tampilpembahasan(id_jawabannya, div_id);
    ...
    function tampilpembahasan(id_jawabannya, div_id) {
        ...
        $.ajax({
            url: '<?php echo $base_api_dashboard; ?>pembahasan_materi/',
            type: 'POST',
            crossDomain: true,
            data: {
                "data": kiriman
            ...
            success: function(res) {
                ...
                $.each(res, function(index, data) {
                    $.each(data, function(k, v) {
                        ...
                        pembahasan += `
                                    ...
                                    <div class="row my-2">                                                
                                        <div class="col-md-12 fw-bold text-primary fs-5">                                
                                            Pembahasan ${v[0].materi_nama} :
                                        </div>
                ...
                if (pembahasan !== '') {
                    ...
                    $("#pembahasan-" + div_id).append(`
                        <row class="my-2">
                            <div class="col-md-12 text-end">
                                Download soal latihan dan pembahasan&nbsp;
                                <b>
                                    <a target="_blank" href="<?php echo $inc_ ?>/print/latihan/${btoa(id_jawabannya)}">
                                        di sini
                    ...
                    `);
                    $("#pembahasan-" + div_id).append(pembahasan);
                }
