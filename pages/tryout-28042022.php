					...
					<div class="row">
						<div class="col-md-6 padding-card">
							...
							<div class="col-md-12 text-center text-md-start">
								<a href="https://edunitas.com/#lokasikampus" target="_blank" class="btn button-secondary btn-lg">Klik di Sini</a>
							</div>
						</div>

						<div class="col-md-6">
							<div class="d-flex justify-content-end">
								<img src="<?php echo $inc_; ?>/assets/img/edunitas-cari-kampus-banner.png" alt="" class="img-fluid image-cari-kampus" />
							</div>
						</div>
					</div>
				</div>
...
<style>
	...
	.header-input .form-control {
		...
		font: normal normal normal 15px Open Sans !important;
		letter-spacing: 0px;
		color: #707070;
	}
</style>
<section id="educampus" class="py-5 my-0 position-relative" style="background-color:#F4F5F9;">
	<div class="container" style="height:100%">
		<div class="row" style="height:100%">
			<div class="col-lg-12 py-0 mx-auto my-auto px-0">
				<div class="row flex-fill mx-auto">
					<div class="col d-flex flex-column">
						<h3 class="text-bold2 mb-4 fw-bold">Temukan Kampus Favorit</h3>
						<h5 class="text-home mb-1" style="font-size:18px;">
							Di sini kamu bisa mencari Kampus favorit kamu dengan berbagai program perkuliahan,
							<a href="https://edunitas.com/p/kuliah-karyawan" class="text-link text-bold2 fw-bold" rel="nofollow">Kuliah Karyawan</a>,
							D3, S1, S2,
							<a href="https://edunitas.com/p/kuliah-kelas-malam" class="text-link text-bold2 fw-bold" rel="nofollow">Kelas Malam</a>,
							<a href="https://edunitas.com/p/program-kuliah-reguler" class="text-link text-bold2 fw-bold" rel="nofollow">Program Kuliah Reguler</a>,
							<a href="https://edunitas.com/p/kuliah-online" class="text-link text-bold2 fw-bold" rel="nofollow">Kuliah Online</a>,
							<a href="https://edunitas.com/p/blended-learning" class="text-link text-bold2 fw-bold" rel="nofollow">Blended Learning</a>,
							<a href="https://edunitas.com/p/kuliah-kelas-sabtu-minggu" class="text-link text-bold2 fw-bold" rel="nofollow">Kuliah Kelas Sabtu Minggu</a>,
							program studi, biaya kuliah, prospektus lulusan, dan lain-lain. &nbsp;<br>
						</h5>
					</div>
				</div>

				<div class="row mb-0 mx-auto mt-5">
					<div class="col-md-6 my-md-auto mb-3">
						<div class="input-group input-group-lg header-input">
							<input id="searchkampus" type="text" class="form-control ui-autocomplete-input" placeholder="Ketik untuk mencari Kampus atau Prodi" autocomplete="off" onkeydown="search(this)">
							<div class="input-group-append">
								<button onclick="nyari('kampus')" class="btn btn-edu-warning text-black px-4" type="button" style="border-radius: .3rem;!important;border-top-left-radius: 0;border-bottom-left-radius: 0;height:100%!important;">
									<i class="fas fa-search"></i>
								</button>
							</div>
						</div>
					</div>
					<div class="col-md-3 mx-auto my-md-auto mb-3"><a href="https://edunitas.com/daftar/educampus" class="btn btn-edu-warning w-100 btn-block btnradius shadow" rel="nofollow">Daftar Online</a></div>
					<div class="col-md-3 my-md-auto mb-3 "><a target="_blank" href="https://edunitas.com/#lokasikampus" class="btn btn-danger w-100 btn-block btnradius shadow" rel="nofollow">Cari Kampus/Prodi</a></div>
				</div>
			</div>
		</div>
	</div>
...
<script>
	function nyari(kategori) {
		if (kategori == 'kampus') {
			let katakuncinya = $("#searchkampus").val();
			//window.location.href = 'https://edunitas.com/educampus/carikampus/semua-wilayah/semua-kelas/semua-prodi?search=' + katakuncinya;
			window.open('https://edunitas.com/educampus/carikampus/semua-wilayah/semua-kelas/semua-prodi?search=' + katakuncinya, '_blank');
		}
	}
									...
									<div class="p-3 position-relative">
										<div class="list-card-body">
											...
											<p class="text-gray time d-flex">
												...
												<span class="card-text ms-auto p-1"><a target="_blank" href="https://edunitas.com/edunews/detail/` + linknews.replace(/=/g, "") + `" class="btn btn-sm round btn-primary px-4 fw-bold">Selengkapnya</a></span>
											</p>
										</div>
									</div>
								</div>
