...
if ($sesi['email'] == 'traffandy@edunovasi.com') {
	// eduprint($dataevent);
...
.banner-overlay {
    ...
    right: 0;
    bottom: 0;
    background: linear-gradient(92deg, #f77f00 8%, rgba(255, 170, 81, 0) 32%);
    background-size: cover;
}
            ...
            <div class="carousel-inner" style="border-radius: 16px">
                    ...
                    <div class="row">
                        <div class="col-md-5 padding-card">
                            ...
                            <div class="second-subheader">
                                Untuk kemudahan pengguna smartphone kini Edunovasi telah hadir di <b>Play Store</b>
                            ...
                            <div class="mt-4">
                                <a href="https://apps.apple.com/id/app/edunovasi-mobile/id1632579053" target="_blank">
                                    <img class="me-2" src="<?php echo $inc_ ?>/assets/ic/app-store.png"
                                        style="height:32px">
                                </a>
                                <a href="https://play.google.com/store/apps/details?id=com.edunovasi" target="_blank">
                                    <img class="me-2" src="<?php echo $inc_ ?>/assets/ic/play-store.png"
                                        style="height:32px">
                                </a>
                            </div>
                        </div>
                        <div class="col-md-7 position-relative">
                            ...
                            <img src="<?php echo $inc_ ?>/assets/img/edunovasi-tryout-app.jpg" alt=""
                ...
                <div class="carousel-item bacground-banner" data-bs-interval="10000">
                    <div class="row">
                        ...
                        <div class="col-md-7 position-relative">
                            <div class="banner-overlay"></div>
                            <img src="<?php echo $inc_ ?>/assets/img/edunovasi-edunitas-tryout.jpg" alt=""
                                class="img-fluid w-100 h-100" />
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item bacground-banner" data-bs-interval="10000">
                    <div class="row">
                        ...
                        <div class="col-md-7 position-relative">
                            <div class="banner-overlay"></div>
                            <img src="<?php echo $inc_ ?>/assets/img/edunovasi-tryout-utbk-2023.jpg" alt=""
                                class="img-fluid w-100 h-100" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-5 padding-card">
                            ...
                            <div class="col-md-12 text-center text-md-start">
                                <a href="https://edunitas.com/educampus" target="_blank"
                                    class="btn button-secondary btn-sm py-1">Klik di Sini</a>
                            </div>
                        </div>
                        <div class="col-md-7 position-relative">
                            <div class="banner-overlay"></div>
                            <img src="<?php echo $inc_ ?>/assets/img/edunovasi-edunitas-kuliah-kelas-karyawan.jpg"
                ...
                <form method="post" id="form-testimoni">
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="txtEmail" name="email" aria-describedby="emailHelp"
                            value="<?php echo $sesi['email'] ?>" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Saran/Masukan</label>
                        <textarea name="saran" class="form-control" id="text_saran" rows="5"
                            style="resize:none;"></textarea>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                        <fieldset class="rating">
                            <input type="radio" id="star5" name="bintang" value="5" /><label for="star5"
                                title="Sangat Bagus">5stars</label>
                            <input type="radio" id="star4" name="bintang" value="4" /><label for="star4" title="Bagus">4
                                stars</label>
                            <input type="radio" id="star3" name="bintang" value="3" /><label for="star3"
                                title="Cukup">3stars</label>
                            <input type="radio" id="star2" name="bintang" value="2" /><label for="star2"
                                title="Kurang Bagus">2 stars</label>
                            <input type="radio" id="star1" name="bintang" value="1" /><label for="star1"
                                title="Tidak Bagus">1 star</label>
                        </fieldset>
                        <div class="">Bintang</div>
                    </div>
                    <div class="mt-5 d-flex justify-content-center">
                        <button type="submit" id="btn_testimoni" class="btn btn-primary w-100">Kirim</button>
                    </div>
                </form>
            </div>
        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-biru py-3">
                                            <div class="d-flex justify-content-center text-white">
                                                <div class="mx-2">
                                                    <img class="img-fluid mb-1" src="assets/ic/date_putih.svg"> <b><span
                                                            class="d-none d-md-inline-flex">Periode :</span>
                                        ...
                                        <div class="card-body bg-white">
                                            <div class="row">
                                                ...
                                                <?php
														...
														?>
                                                <div class="col-md-6 my-md-auto mt-3 text-end"><a
                                                        href="<?php echo $inc_ ?>/mandiri/detail/<?php echo $v['id_event2'] ?>"
                                                        class="btn btn-primary px-5 w-100"><?php echo str_replace("Mandiri ", "", str_replace("MANDIRI ", "", $v['kategori_nama'])) ?></a>
                                                </div>
                                                <?php
														}
														?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex justify-content-start text-primary">
                                            <div class="me-2"><img class="img-fluid mb-1"
                                                    src="assets/ic/timer_biru.svg"><?php echo $val['waktu'] ?> menit
                                            </div>
                                            <div class="me-2"><img class="img-fluid mb-1"
                                                    src="assets/ic/task_biru.svg"><?php echo $val['jumlah_soal'] ?> soal
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 my-md-auto mt-3 text-end"><a
                                            href="<?php echo $inc_ ?>/event/detail/<?php echo $val['id_event'] ?>"
                                        ...
                                        <div class="card-body bg-white">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-flex justify-content-start text-primary">
                                                        <div class="me-2"><img class="img-fluid mb-1"
                                                                src="assets/ic/timer_biru.svg"><?php echo $val['waktu'] ?>
                                                            menit</div>
                                                        <div class="me-2"><img class="img-fluid mb-1"
                                                                src="assets/ic/task_biru.svg"><?php echo $val['jumlah_soal'] ?>
                                                            soal</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 my-md-auto mt-3 text-end"><a
                                                        href="<?php echo $inc_ ?>/skd/detail/<?php echo $val['id_event'] ?>"
                                                        class="btn btn-primary px-5">Lihat Detail</a></div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 small my-md-auto mt-3 text-end ">
                                        <a href="<?php echo $inc_ ?>/latihan/detail/<?php echo str_replace(" ", "-", $val['judul']) ?>"
                                ...
                                <div class="card-body px-2 pt-3 pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 div-image">
                                            <img src="<?php echo $inc_; ?>/assets/img/testimoni/Juara 1 Saintek - Alfin Hoirul Alif.jpg"
                                                class="img-fluid img-thumbnail testi-image">
                                        </div>
                            ...
                            <div class="card rounded-10 text-center" style="transform: scale(0.90);">
                                <div class="card-body px-2 pt-3 pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 div-image">
                                            <img src="<?php echo $inc_; ?>/assets/img/testimoni/Juara 2 Saintek - Galen Chandrawira.jpg"
                                                class="img-fluid img-thumbnail testi-image rounded-10">
                                        </div>
                            ...
                            <div class="card rounded-10 text-center" style="transform: scale(0.90);">
                                <div class="card-body px-2 pt-3 pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 div-image">
                                            <img src="<?php echo $inc_; ?>/assets/img/testimoni/Juara 3 Saintek - Cleodylon R.jpg"
                                                class="img-fluid img-thumbnail testi-image">
                                        </div>
                                        <div class="col-md-12 div-juara pt-5 pb-4">
                                            <div class="row g-1">
                            ...
                            <div class="card rounded-10 text-center">
                                <div class="card-body px-2 pt-3 pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 div-image">
                                            <img src="<?php echo $inc_; ?>/assets/img/testimoni/Juara 1 Soshum - Faiz Attaqi.jpg"
                                                class="img-fluid img-thumbnail testi-image">
                                        </div>
                                        <div class="col-md-12 div-juara1 pt-5 pb-4">
                                            <div class="row g-1">
                            ...
                            <div class="card rounded-10 text-center" style="transform: scale(0.90);">
                                <div class="card-body px-2 pt-3 pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 div-image">
                                            <img src="<?php echo $inc_; ?>/assets/img/testimoni/Juara 2 Soshum - Syifa Azzahrah.jpg"
                                                class="img-fluid img-thumbnail testi-image rounded-10">
                                        </div>
                                        <div class="col-md-12 div-juara pt-5 pb-4">
                                            <div class="row g-1">
                            ...
                            <div class="card rounded-10 text-center" style="transform: scale(0.90);">
                                <div class="card-body px-2 pt-3 pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 div-image">
                                            <img src="<?php echo $inc_; ?>/assets/img/testimoni/Juara 3 Soshum - Aleeja Sausanja.jpg"
                                                class="img-fluid img-thumbnail testi-image">
                                        </div>
                                        <div class="col-md-12 div-juara pt-5 pb-4">
                                            <div class="row g-1">
            ...
            <div class="col-md-12">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="list-card bg-white h-100 rounded-3 overflow-hidden position-relative shadow-sm">
                            <div class="list-card-image">
                                <img src="./assets/img/lowongan-kerja-edunitas.jpg" class="img-fluid"
                                    style="width:100%;height:164px; object-fit:cover" alt="Lowongan Kerja Edunitas">
                            </div>
                            <div class="p-3 position-relative">
                                <div class="list-card-body">
                                    <h6 class="mb-1 fw-bold" style="min-height:40px">
                                        <a target="_blank" href="https://edunitas.com/lowongan-kerja"
                                            class="text-decoration-none fw-bold">Lowongan Kerja Terbaru 2022</a>
                                    </h6>
                                    <!-- <hr>
                    ...
                    <div class="col-md-4">
                        <div class="list-card bg-white h-100 rounded-3 overflow-hidden position-relative shadow-sm">
                            <div class="list-card-image">
                                <img src="./assets/img/kuliah-edunitas.jpg" class="img-fluid"
                                    style="width:100%;height:164px; object-fit:cover" alt="Kuliah Edunitas">
                            </div>
                            <div class="p-3 position-relative">
                                <div class="list-card-body">
                                    <h6 class="mb-1 fw-bold" style="min-height:40px">
                                        <a target="_blank" href="https://edunitas.com/kuliah"
                                            class="text-decoration-none fw-bold">Cara Investasi Kuliah</a>
                                    </h6>
