...
if (isset($_POST['btn_peserta'])) {
	...
	if ($postcurl_peserta['status'] != '200') {
		...
		echo "<script>window.location.href='" . $inc_ . "/mandiri/ujian/" . $arr_urinya[4] . "'</script>";
	}
}
...
if (strpos($dataeventd['judul'], 'UI') !== false) {
	$impian_kampus = 'Universitas Indonesia';
	$impian_read = 'readonly';
}
if (strpos($dataeventd['judul'], 'UGM') !== false) {
	$impian_kampus = 'Universitas Gadjah Mada';
	$impian_read = 'readonly';
}
								...
								<div class="row g-3">
									<div class="col-md-6">
										<div class="row g-3">
											...
											<div class="col-md-12">
												<div class="card bg-light text-dark border shadow-sm">
													<img src="https://file.edunitas.com/assets/news/img/1655707330351/medium-imgcover_1655707330351.jpg" class="card-img" alt="Try Out Ujian Mandiri UI dan UGM" style="opacity:0.5; object-fit:cover; width:100%; height:180px">
													<div class="card-img-overlay">
														<h6 class="card-title fw-bold">Alur Pendaftaran dan Pengerjaan Try Out Ujian Mandiri</h6>
														<p class="card-text small">Try Out Ujian Mandiri Edunovasi: Simak UI dan UM UGM, Untuk memudahkan akses Sahabat dalam mengerjakan Try Out Ujian Mandiri Edunovasi, silakan baca panduan alur pendaftaran dan pengerjaan try out di Edunovasi ya.</p>
														<p class="card-text"><a href="https://edunitas.com/edunews/detail/try-out-ujian-mandiri-simak-ui-dan-um-ugm" target="_blank">Klik di sini</a></p>
													</div>
												</div>
											</div>
										</div>
												...
												<div class="card-body card-border">
													...
													<form id="form-peserta" class="row g-4" method="POST">
														...
														<div class="col-md-6">
															...
															<input type="text" class="form-control" id="kampus_impian" name="kampus_impian" placeholder="" value="<?php echo $impian_kampus ?>" required <?php echo $impian_read ?>>
														</div>
														<div class="col-md-6">
...
<script>
	...
	function gotologin() {
		sessionStorage.setItem("tryout_goto", "/mandiri/detail/<?php echo $arr_urinya[4] ?>");
