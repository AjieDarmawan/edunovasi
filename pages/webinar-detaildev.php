...
if (isset($_POST['btn_pendaftaran'])) {
    ...
    if ($postcurl_peserta['status'] == '200') {
        ...
        swal.fire({
            ...
            text:"Kamu sudah terdaftar sebagai peserta webinar ini, silakan join grup wa <br><br><a href="' . $datawebinard['share_link'] . '" target="_blank">' . $datawebinard['share_link'] . '</a><br><br> dan cek email kamu untuk proses selanjutany"
        })
        </script>';
