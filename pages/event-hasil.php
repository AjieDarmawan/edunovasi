...
<section id="nilai" class="my-4">
    <div class="container">
        <div class="alert alert-warning alert-dismissible fade show mb-4" role="alert">
            ...
            <strong>Berhasil</strong> menyelesaikan Try Out, berikut hasil dari Ujian Kamu.<br>Kamu juga bisa melihat <b>histori ujian pertama kamu</b> di menu Dashboard</a><br>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4 bg-nilai rounded shadow-sm d-flex">
                        <div class="my-auto mx-auto d-flex">
                            ...
                            <div class="fw-bold text-black fs-4 my-auto">Proses IRT</div>
                    ...
                    <div class="col-md-12 text-md-end text-center">
                        <div class="row">
                            <div class="col-md-7 text-md-start small">
                                Note :<br>
                            ...
                            <?php 
                                if($getcurl_hasil['kedinasan']==3){

                                }else{
                             ?>
                            <div class="col-md-5 mt-md-auto mt-3">
                                Download soal event dan pembahasan&nbsp;
                                <b>
                                    <a target="_blank" href="<?php echo $inc_ ?>/print/event_irt/<?php echo $print_event; ?>">
                                        di sini
                ...
                <div class="card-body" style="min-height:50vh">
                    <div class="row g-2">
                        ...
                        <div class="col-md-12 text-primary fs-6 text-center">
                            ...
                            Nilai dan Pembahasan dapat diakses pada menu Dashboard setelah Event Try Out berakhir<br>
                        </div>
                    </div>
                </div>
            </div> -->
