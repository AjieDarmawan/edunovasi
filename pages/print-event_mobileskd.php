...
$link = '';
$namafile = 'tryoutskd_' . base64_decode($data['id_event']) . '-' . $data['id_peserta'] . '-' . date('Ymdhis') . '.pdf';
...
if (file_exists($pathpdf)) {
    ...
    if (!$getcurl_hasil) {
        $balikan['status'] = '400';
        $balikan['message'] = 'Gagal cari nilai';
        $balikan['data'] = '';
        $balikan['namafile'] = '';
    ...
    if (!$getcurl_pembahasan) {
        $balikan['status'] = '400';
        $balikan['message'] = 'Gagal load pembahasan';
        $balikan['data'] = '';
        $balikan['namafile'] = '';
        echo json_encode($balikan);
        exit;
...
if (file_exists($pathpdf)) {
    ...
    $balikan['status'] = '400';
    $balikan['message'] = 'Gagal Download';
    $balikan['data'] = '';
    $balikan['namafile'] = '';
    echo json_encode($balikan);
    exit;
