...
$getcurl_event = postcurl($base_api_sekolah . 'event_ranking_sekolah', $data);
...
<script>
    function tampilnilai(id_eventnya, id_pesertanya, div_id, no) {
        ...
        $.ajax({
            url: '<?php echo $base_api_sekolah; ?>cari_nilai/',
            type: 'POST',
            crossDomain: true,
            data: {
                "data": kiriman
            ...
            success: function(res) {
                ...
                $.ajax({
                    url: '<?php echo $base_api_sekolah; ?>hasil_skor_irt/',
                    type: 'POST',
                    crossDomain: true,
                    data: {
                        "data": kiriman
                    ...
                    success: function(respon) {
                        $.each(respon.data, function(key, val) {
                            ...
                            $.each(val, function(k, irt) {
                                ...
                                no++;
                                skor_average = skor_average + parseFloat(irt['skor']);
                                skor_jumlah++;
                            });
                            nilai_irt += `
                        ...
                        let dom_nilai = `
                                <div class="row p-md-3 mb-3">
                                    ...
                                    <div class="col-md-12 small alert alert-danger">
                                        Note :<br> 
                                        Selama event berlangsung, skor IRT dapat berubah berdasarkan jumlah peserta yang mengikuti ujian dan akan diupdate setiap 3 jam sekali. Jawaban dan pembahasan akan muncul setelah event selesai.
                                    </div>
                                </div>
                                ${dom_irt}
                            `;
                    ...
                    $("#pembahasan-" + div_id).prepend(`
                        <div class="mb-3">
                            <div class="col-md-12 text-end">
                                ...
                                <b>
                                    <a target="_blank" href="<?php echo $inc_ ?>/print/event_irt/${print_event}">
                                        di sini
