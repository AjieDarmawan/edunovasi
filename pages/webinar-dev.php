...
if (isset($_POST['btn_pendaftaran'])) {
    ...
    if ($postcurl_peserta['status'] == '200') {
        ...
        swal.fire({
            ...
            text:"Kamu sudah terdaftar sebagai peserta webinar ini, silakan cek email kamu"
        })
        </script>';
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="<?php echo $datawebinard['foto'] ?>" class="img-fluid rounded-start"
                                alt="<?php echo $datawebinard['topik'] ?>">
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="grupdesc mb-4">
                                            ...
                                            <div class="desc mb-2"><?php echo $datawebinard['jabatan_pembicara'] ?>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="rate">
                                                <input type="radio" id="star6" name="rate" value="6"
                                                    onclick="sendrating('6')" />
                                                <label for="star6" title="Sangat Baik">6 stars</label>
                                                <input type="radio" id="star5" name="rate" value="5"
                                                    onclick="sendrating('5')" />
                                                <label for="star5" title="Baik">5 stars</label>
                                                <input type="radio" id="star4" name="rate" value="4"
                                                    onclick="sendrating('4')" />
                                                <label for="star4" title="Cukup Baik">4 stars</label>
                                                <input type="radio" id="star3" name="rate" value="3"
                                                    onclick="sendrating('3')" />
                                                <label for="star3" title="Agak Kurang">3 stars</label>
...
<section id="gabung" class="py-4 bg-oren">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-md-start text-center my-auto fw-bold fs-4 text-white">Form Pendaftaran
                <?php echo $datawebinard['topik'] ?></div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama"
                                        value="<?php echo $sesi['nama'] ?>" required>
                                </div>
                                <div class="col-md-4">
                                    <label for="email" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="email" name="email"
                                        value="<?php echo $sesi['email'] ?>" required>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" class="form-control" id="usia" name="usia" value="" required
                                        min="1" max="99">
                                </div>
                                <!-- <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="no_wa" name="no_wa" placeholder=""
                                        value="<?php echo $sesi['no_wa'] ?>" required>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4 mx-auto mt-md-auto mt-5 text-end">
                                    <input type="hidden" class="form-control" id="id_event" name="id_event"
                                        value="<?php echo base64_encode($datawebinard['id_webinar']) ?>" required>
                                    <button type="button" name="btn_pendaftar" id="btn_pendaftar"
                                        class="btn btn-sm btn-primary w-100 p-2">Daftar Sekarang</button>
                                    <button type="submit" name="btn_pendaftaran" id="btn_pendaftaran"
                                        style="display:none">Untuk Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        success: function(res) {
            ...
            if (res.response == 'OK') {
                ...
                swal.fire({
                    ...
                    html: "Kami telah mengirimkan akun tryout edunovasi ke email kamu untuk melihat link zoom pada hari penyelenggaraan, selain itu kamu bisa login dan akses ujian tryout atau latihan soal juga loh",
                }).then((ok) => {
                    $("#btn_pendaftaran").click();
                });
