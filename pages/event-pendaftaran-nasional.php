...
if (isset($_POST['btn_pendaftaran'])) {
    ...
    if ($postcurl_peserta['status'] == '200') {
        $linktele = "https://bit.ly/TelegramTemanBelajar";
        echo '<script>
        swal.fire({ 
            icon: "success",
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 my-auto text-center position-relative">
                <img class="img-fluid rounded shadow" src="<?php echo $inc_ ?>/assets/img/edunovasi-try-out-nasional-2023-skolastik.jpg">
            </div>
            <div class="col-md-7 my-auto">
                <div class="row">
                    <div class="col-md-12 title mt-md-0 mt-3">
                        Try Out Nasional UTBK 2023 Tes Skolastik
                    </div>
                    ...
                    <div class="col-md-10 mt-2">
                        <div class="card rounded shaadow-sm">
                            <div class="card-body">
                                Pelaksanaan : <b>24-30 September 2022</b><br>
                                Batas Pendaftaran : <b>23 September 2022</b><br><br>
...
<?php
$tgl_skrg = date("Y-m-d");
$tgl_tutup = date("Y-m-d", strtotime("2022-09-24"));
if ($tgl_skrg < $tgl_tutup) {
?>
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-8 my-auto fw-bold fs-5">
                                    <?php
                                    echo "Form Pendaftaran Peserta Ujian Try Out Nasional " . (date("Y") + 1);
                                    ?>
                                </div>
                                <div class="col-md-4 my-auto">
                                    <div class="row">
                                        <div class="col-md-12 text-end my-3">
                                            <img class="img-fluid mb-1 me-2" src="<?php echo $inc_ ?>/assets/ic/date_biru.svg">Periode : <b>24 - 30 Sep 2022</b>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <form id="form-peserta" class="row g-4" method="POST">
                                                    <div class="col-md-4">
                                                        ...
                                                        <select id="id_event" name="id_event" class="form-select" required>
                                                            ...
                                                            <option value="OTk2">TO Nasional SAINTEK</option>
                                                            <option value="OTk3">TO Nasional SOSHUM</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-4">
...
?>
    <section id="detail-event2" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="card py-5">
                        <div class="card-body" style="min-height:50vh">
                            <div class="row g-4 justify-content-center">
                                ...
                                <div class="col-md-12 text-primary fs-6 text-center">
                                    <span class="fw-bold fs-5">Pendaftaran sudah ditutup</span><br>
                                    Jika kamu sudah pernah mendaftar untuk ikut Ujian Nasional silakan ikuti event pada link berikut ini
                                </div>
                                <div class="col-md-4 col-6">
                                    <a href="https://edunovasi.com/event/detail/MjQx" class="btn btn-primary px-5 w-100">Try Out SKOLASTIK UTBK 2023</a>
                                </div>
                                <!-- <div class="col-md-3 col-6">
                                    <a href="https://edunovasi.com/event/detail/NDk=" class="btn btn-primary px-5 w-100">Try Out SOSHUM</a>
                                </div> -->
                            </div>
                        </div>
                    </div>
