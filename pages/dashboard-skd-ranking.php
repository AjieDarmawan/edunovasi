...
$getcurl_event = postcurl($base_api_dashboard_dinas . 'event_ranking', $data);
                ...
                <div class="card-body" style="min-height:50vh">
                    <div class="row g-2">
                        ...
                        <div class="col-md-12 text-primary fs-6 text-center">
                            <span class="fw-bold fs-5">Kamu belum mengikuti Event SKD</span><br>
                            Silakan ikuti event SKD lewati ambang batas dan raih skor tertinggi !
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    function tampilranking(id_eventnya, div_id, judul, tgl, no, show) {
        ...
        if (show == '1') {
            ...
            $.ajax({
                url: '<?php echo $base_api_dashboard_dinas; ?>list_hasil_rangking/',
                type: 'POST',
                crossDomain: true,
                data: {
                    "data": kiriman
                ...
                success: function(res) {
                    ...
                    if (res.status == '400') {
                        ...
                        <div class="row g-2 py-3">
                            ...
                            <div class="col-md-12 mt-3 text-primary fs-6 text-center">
                                Ranking sedang dalam proses perhitungan
                            </div>                
                        </div>
                    `;
                    ...
                    `);
                        ...
                        $.ajax({
                            url: '<?php echo $base_api_dashboard_dinas; ?>check_posisi_rangking/',
                            type: 'POST',
                            crossDomain: true,
                            data: {
                                "data": kirimanposisi
                ...
                error: function(res) {
                    ...
                    let loading = `    
                        <div class="row g-2 py-3">
                            ...
                            <div class="col-md-12 text-primary fs-6 text-center">
                                <span class="fw-bold fs-5">Ranking sedang dalam proses perhitungan</span><br>
