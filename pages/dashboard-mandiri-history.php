...
$getcurl_event = postcurl($base_api_dashboard . 'event_mandiri', $data);
                        ...
                        $.each(respon, function(k, skor) {
                            ...
                            list_nilai_materi += `
                                <div class="row border-bottom py-md-1 py-4 ${light}">
                                    <div class="col-md-4 text-start my-md-auto my-3 fw-bold">
                                        ${ skor['materi_nama'] }
                                    </div>
                                    ...
                                    <div class="card h-100">
                                        <div class="card-header fw-bold bg-white py-3">
                                            <div class="row d-none d-md-flex">  
                                                <div class="col-md-4 d-none d-md-block text-center">Materi</div>
                            ...
                            <div class="row p-md-3 mb-4">
                                ...
                                <div class="col-md-6 bg-warning rounded shadow-sm d-flex my-3 my-md-1">
                                    <div class="my-auto mx-auto d-flex">
                                        ...
                                        <div class="fw-bold text-primary display-4 my-auto py-3">${res.skor}</div>
                                    </div>
                                </div>
                            </div>
                            ${dom_nilai_skor}
