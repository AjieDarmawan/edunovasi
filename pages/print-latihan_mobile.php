...
$data = array();
$data['id_jawaban'] = base64_encode($_POST['id_jawaban']);
$data['email'] = base64_encode($_POST['email']);
$data['nama'] = $_POST['nama'];
// eduprint($data);
// exit;

$link = '';
$namafile = 'latihan_' . base64_decode($data['id_jawaban']) . '-' . date('Ymdhis') . '.pdf';
...
if (file_exists($pathpdf)) {
    ...
    <div style="text-align:left">
        ...
        <table> 
            ...
            <tr>
                <td>Email</td>
                <td><b>' . base64_decode($data['email']) . '</b></td>
                <td>Jawaban Salah</td>
