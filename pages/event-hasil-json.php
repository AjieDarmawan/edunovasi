...
$data = array();
$data['id_event'] = "MjE=";
$data['email'] = "daniyal.hafidz@gmail.com";
$data['id_peserta'] = "100";
eduprint($data);
// exit;
...
<section id="nilai" class="my-4">
    <div class="container">
        <div class="alert alert-warning alert-dismissible fade show mb-4" role="alert">
            <strong>Berhasil</strong> menyelesaikan try out, berikut hasil dari try out Kamu, klik di sini untuk melihat <a href="<?php echo $inc_; ?>/event/ranking/<?php echo $arr_urinya[4]; ?>">Ranking</a>
