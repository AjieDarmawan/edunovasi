...
<nav class="navbar navbar-custom <?php echo $stylenavbar; ?> fixed-top navbar-expand-lg">
	<div class="container-fluid px-md-5">
					...
					<table>
						<tr>
							<td style="width:260px;">
								<a href="https://edunovasi.com/#">
									<img href='<?php echo $inc_; ?>' src="<?php echo $inc_; ?>/assets/ic/logodotcom.png" class="img-fluid" style="height:40px; cursor:pointer">
								</a>
							</td>
							<td style="padding:16px 0 0 5px;" nowrap>
								<a class="btnnavbar btn btn-sm btn-primary small" style="font-size:9pt; padding: 4px 16px !important;" target="_blank" href="https://edunitas.com/educampus/carikampus/semua-wilayah/semua-kelas/semua-prodi">Cari Kampus, Cari Prodi</a>
							</td>
						<tr>
					</table>
		...
		<div class="collapse navbar-collapse mb-md-2" id="navbarNav">
			<ul class="navbar-nav ms-auto">
				...
				<li class="nav-item">
					<a class="nav-link position-relative" aria-current="page" href="https://mitra.edunovasi.com">
						EduSchool
						<span class="position-absolute top-1 start-100 translate-middle badge rounded-pill bg-danger" style="font-size:xx-small">
							New
						</span>
					</a>
					<!-- <li class="nav-item">
				...
				<?php
				$connecttoschool = '';
				if (isset($_SESSION['userdata']) && $sesi['id_sekolah'] > 0) {
					$connecttoschool = '<li><a class="dropdown-item" href="' . $inc_ . '/dashboard/akun/logout_from_school">Logout from School</a></li>';
				} else {
					$connecttoschool = '<li><a class="dropdown-item" href="' . $inc_ . '/dashboard/akun/connect_to_school">Connect to School</a></li>';
				}
